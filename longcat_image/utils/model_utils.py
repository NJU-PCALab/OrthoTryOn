...
def encode_prompt_edit2(prompt: str, img: Image.Image, cond_img: Image.Image, tokenizer: AutoTokenizer, image_processor_vl: AutoProcessor,
                       text_tokenizer_max_length: int, prompt_template_encode_prefix: str,
                       prompt_template_encode_suffix: str):
...
def encode_prompt_vton(prompt: str, img_list: list, tokenizer: AutoTokenizer, image_processor_vl: AutoProcessor,
                       text_tokenizer_max_length: int, prompt_template_encode_prefix: str,
                       prompt_template_encode_suffix: str):
    raw_vl_input = image_processor_vl(images=img_list, return_tensors="pt")
